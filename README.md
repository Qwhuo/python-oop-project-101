# Валидатор данных (Python)

[![hexlet-check](https://github.com/Qwhuo/python-oop-project-101/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/Qwhuo/python-oop-project-101/actions)
...
Учебный проект Хекслета: https://ru.hexlet.io/programs/python-oop
...
```bash
git clone https://github.com/Qwhuo/python-oop-project-101.git
